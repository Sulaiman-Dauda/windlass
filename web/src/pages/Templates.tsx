...
export default function Templates() {
  ...
  return (
    <Page title="Templates" subtitle="one-click databases">
      <p className="mb-6 max-w-[68ch] text-sm leading-relaxed text-fg2">
        ...
        Environment tab — no proprietary formats, nothing to lock you in.
      </p>
        ...
        {templates.data?.map((t) => (
          <Card key={t.key} className="flex flex-col gap-3 p-4">
            ...
            {selected === t.key ? (
              ...
              <Button block onClick={() => { setSelected(t.key); setName(t.key); }}>
                Create
              </Button>
            )}
          </Card>
